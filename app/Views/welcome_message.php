...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="<?= base_url('products'); ?>">Product</a></li>
            <li class="nav-item">
          <a class="nav-link" href="<?= base_url('cart/view') ?>">Card</a>
        </li>
            </li>
        </ul>
    </div>
    ...
    <div class="heroe">
     ...
     <h3>API'yi kullanabilmek için her istekle birlikte kullanıcı adı ve API anahtarı 
        gönderilmelidir. Bu kimlik doğrulama, Basic Auth kullanılarak yapılır.
        Users tablosundan çekilir.
    </h3>

        <h2>Kullanıcı Adı: user1   ||| API Anahtarı: 12345678</h2>
        <h6>Basic Auth kullanarak aşağıdaki başlığı isteklerinize ekleyin:</h6>
        <p>Authorization: Basic base64_encode('user1:12345678')
        </p>
...
<section>
    ...
    <h1>API Endpoints</h1>
        <h3>1. Ürün Listeleme</h3>
        <li> URL: /api/products</li>
        <li>Metod: GET</li>
       <li> Kimlik Doğrulama: Gerekli</li>
       <pre><code>[
    {
        "id": 1,
        "name": "Ürün 1",
    ...
    },
    {
       ...
       <h3>2. Ürün Ekleme</h3>
        ...
        <li>Metod: POST</li>
       <li> Kimlik Doğrulama: Gerekli</li>
       <li>İçerik Türü: application/json</li>
       <pre>
        <code>
            {
            "name": "Yeni Ürün",
